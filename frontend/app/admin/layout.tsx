      ...
      <div className="portal-layout">
        ...
        <aside className={`portal-sidebar ${isSidebarOpen ? 'open' : ''}`}>
          <div className="portal-brand">
            <div className="portal-logo-badge">🏛️</div>
            <div className="portal-brand-text">
              <span className="portal-brand-title">Academic Management</span>
              <span className="portal-brand-subtitle">Institution Control Portal</span>
            </div>
          </div>
          ...
          <div className="portal-admin-card">
            ...
            <div className="admin-meta">
              ...
              <span className="admin-role-badge">Dean / Admin</span>
            </div>
          </div>

          <nav className="portal-nav">
            <div className="nav-section-label">Academic Management</div>
            {NAV_ITEMS.map((item) => {
              const isActive =
                item.path === '/admin'
                  ? pathname === '/admin'
          ...
          <div className="portal-top-bar">
            <div className="top-bar-left">
              <div className="live-indicator">
                ...
                <span className="live-text">Academic Source-of-Truth Active</span>
              </div>
            </div>
